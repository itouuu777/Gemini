...
void setup(void)
{
  pinMode(4, INPUT_PULLUP); //SDA 21番ピンのプルアップ(念のため)
  pinMode(5, INPUT_PULLUP); //SDA 22番ピンのプルアップ(念のため)
 ...
 */
  ...
  Serial.print(" Ac_xyz:");
  Serial.println(accelermetor.x());
  Serial.print(", ");
  Serial.println(accelermetor.y());
  Serial.print(", ");
  Serial.println(accelermetor.z());
 ...
 // オイラ角取得
  ...
  double rolls = roll * 57.2957795131;   // ラジアンから度に変換
  double pitchs = pitch * 57.2957795131;  // ラジアンから度に変換
